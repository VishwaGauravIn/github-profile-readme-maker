...
export default function HomePage() {
  return (
    <div className="w-full flex flex-col md:flex-row mt-16 md:mt-28">
      <div className="flex flex-col w-full md:w-6/12">
        <p className="text-6xl md:text-7xl 2xl:text-8xl">
          Best Profile Generator
        </p>
        {/* Text Input */}
        <div className="flex mt-8 md:md:my-16 items-center">
          <input
            type="text"
            name=""
            id=""
          ...
          <svg
            ...
            className="h-8 w-12 cursor-pointer transition-all hover:w-14 duration-200 ease-linear"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
